...
flags.DEFINE_float("learning_rate", 2.5e-4, "Learning rate [2.5e-4]")
...
def genChipModel():
	...
	hidden1 = Dropout(0.5)(Dense(256, activation = 'relu')(inputs))
	hidden2 = Dropout(0.5)(Dense(512, activation = 'relu')(hidden1))
	#hidden3 = Dropout(0.5)(Dense(512, activation = 'relu')(hidden2))
	hidden3 = Dropout(0.5)(Dense(512, activation = 'relu')(hidden2))
	hidden4 = Dropout(0.5)(Dense(256, activation = 'relu')(hidden3))
